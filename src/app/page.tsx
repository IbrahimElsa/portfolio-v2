...
const technologies = [
  ...
  { name: 'TypeScript', icon: 'devicon-typescript-plain', hoverClass: 'group-hover:text-blue-400' },
  ...
  { name: 'Python', icon: 'devicon-python-plain', hoverClass: 'group-hover:text-yellow-400' },
  ...
  { name: 'Git', icon: 'devicon-git-plain', hoverClass: 'group-hover:text-orange-600' },
  ...
  { name: 'Firebase', icon: 'devicon-firebase-plain', hoverClass: 'group-hover:text-yellow-600' },
